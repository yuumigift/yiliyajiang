...
export default {
	...
	data(){
		return {
			...
			recommend:[
				{id:'001',image:require('.././assets/images/cool_card.png'),name:'炫酷卡片',content:'热门',url:''},
			...
			products:[
				...
				{id:'018',image:require('.././assets/images/time_table.png'),name:'时间表',recommend:'这是一段属于该产品的专属介绍！！！',url:''},
