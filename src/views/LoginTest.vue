<template>
  ...
  <div class="treasure">
    <!--		弹出注册层-->
    <div style="margin-left: 36%;margin-top: 50%;;font-size: 17px;position:absolute;">
      <my-label font-size="11" message="本网页不支持手机端"></my-label>
    </div>
    ...
    <div style="margin-left: 32%;margin-top: 9%;">
    ...
    <div style="margin-left: 40%;font-size: 20px">
      <my-button
          class="ass"
          height="59px"
          style="cursor: pointer;width: 12%;pointer-events: none"
          @click="register"
    ...
    <div style="margin-top: 10%;font-size: 17px">
      <green-label message="如果页面显示不全请缩小至75%"></green-label>
    </div>
  </div>
</template>
